...
11. **[Dinamik Yönlendirme (BGP/OSPF)](11_dinamik_yonlendirme_bgp_ospf.md)**: WireGuard üzerinde FRRouting (FRR) kullanarak BGP yönlendirmesi, Point-to-Point arayüz mimarisi ve Route Filtering detayları.
12. **[Performans Optimizasyonu (Tuning)](12_performans_optimizasyonu.md)**: Yüksek hızlı (10Gbps+) ağlarda maksimum verim için UDP buffer, CPU Affinity, Rx/Tx Ring ve TCP BBR ayarları.
